...
const serve = (request, response) => {
	...
	response.setHeader(
		...
		`default-src 'none'; style-src ${styleSrc}; img-src https://api.tumblr.com https://*.media.tumblr.com https://assets.tumblr.com; media-src https://a.tumblr.com https://*.media.tumblr.com https://vtt.tumblr.com; form-action 'self'; frame-ancestors 'none'`
	);
